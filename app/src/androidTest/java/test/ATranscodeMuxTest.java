...
public class ATranscodeMuxTest extends  AExampleInstrumentedTest{

    private static final String TAG = ATranscodeMuxTest.class.getSimpleName();
    ...
    private static class TestWrapper implements Runnable {
        ...
        private ATranscodeMuxTest mTest;

        private TestWrapper(ATranscodeMuxTest test) {
            mTest = test;
        }
         ...
         * Entry point.
         */
        public static void runTest(ATranscodeMuxTest test) throws Throwable {
            test.setOutputFile();
    ...
    private void extractDecodeEditEncodeMux() throws Exception {
        ...
        test.InputSurface inputSurfacexxx = null;
        ...
        try {
            if (mCopyVideo) {
                ...
                AtomicReference<Surface> inputSurfaceReferencexx = new AtomicReference<Surface>();
...
//                    ByteBuffer inputBuf = videoEncoderOutputBuffers[inputBufIndex];
                }
