 ...
 * gets a bit unwieldy).
 */
public class DecodeEditEncodeTest  extends AExampleInstrumentedTest{
    ...
    private void editVideoData(VideoChunks inputData, MediaCodec decoder,
                               test.OutputSurface outputSurface, InputSurface inputSurface, MediaCodec encoder,
    ...
    private void checkVideoFile(VideoChunks inputData) {
        test.OutputSurface surface = null;
        MediaCodec decoder = null;
        ...
        try {
            surface = new test.OutputSurface(mWidth, mHeight);
     ...
     */
    private int checkVideoData(VideoChunks inputData, MediaCodec decoder, test.OutputSurface surface) {
